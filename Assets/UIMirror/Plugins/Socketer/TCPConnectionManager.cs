...
namespace Microsoft.MixedReality.SpectatorView
{
    ...
    public class TCPConnectionManager : MonoBehaviour
    {
        ...
        private void OnServerConnected(SocketerClient client, MessageEvent e)
        {
            Debug.Log("Server connected to " + e.SourceHost);
            SocketEndpoint socketEndpoint = new SocketEndpoint(client, timeoutInterval, e.SourceHost, e.SourceId);
            serverConnections[e.SourceId] = socketEndpoint;
