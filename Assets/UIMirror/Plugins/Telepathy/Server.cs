...
namespace Telepathy
{
    public class Server : Common
    {
        ...
        public bool Active => listenerThread != null && listenerThread.Status == TaskStatus.Running;
        ...
        public bool Start(int port)
        {
            ...
            listenerThread = new Task(() => { Listen(port); });
...
#if NETFX_CORE
                try { client.GetStream().Dispose(); } catch {}
                client.Dispose();
#else
